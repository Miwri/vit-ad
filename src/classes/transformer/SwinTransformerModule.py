"""Module which copies the implementation of SwinTransformer class from Touvron et al. https://github.com/microsoft/esvit
"""
...
class WindowAttention(nn.Module):
    ...
    def extra_repr(self) -> str:
        return (
            f"dim={self.dim}, window_size={self.window_size}, num_heads={self.num_heads}"
        )
